...
// Source: F:\git_push\webook\internal\repository\code.go
...
func (m *MockCodeRepository) Set(ctx context.Context, biz, phone, code string, cnt int) error {
	m.ctrl.T.Helper()
...
func (mr *MockCodeRepositoryMockRecorder) Set(ctx, biz, phone, code, cnt interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Set", reflect.TypeOf((*MockCodeRepository)(nil).Set), ctx, biz, phone, code, cnt)
}
