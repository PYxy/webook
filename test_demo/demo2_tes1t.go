...
//}
//
//func NewUserDAO(p DBProvider) UserDaoInterface {
//	//法1
//	u := &UserDAO{
//		//db: GDB,
//	}
...
//	//读取配置文件
//	NewDB()
//	a := NewUserDAO(func() *gorm.DB {
//		fmt.Println("unsafe操作获取到的1:", (*gorm.DB)(atomic.LoadPointer(&GDB)))
//		return (*gorm.DB)(atomic.LoadPointer(&GDB))
//
//	})
//
